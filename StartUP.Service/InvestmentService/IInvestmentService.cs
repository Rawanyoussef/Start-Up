...
namespace StartUP.Service.InvestmentService
{
    ...
    {
        Task<int> AddAsync(InvestmentRequestDto investment, int userId);
     ...
     //   Task<bool> UpdateAsync(int id ,InvestmentRequestDto investment);
       ...
       Task<IEnumerable<investmentPending>> GetAllPendingAsync();
        ...
        Task<bool> AcceptInvestment(AcceptDto acceptInvestmentDto, int SenderId);
        Task<bool> RejectInvestment(AcceptDto acceptInvestmentDto, int SenderId);
