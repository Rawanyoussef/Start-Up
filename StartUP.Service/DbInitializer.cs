...
public static class DbInitializer
{
    public static async Task InitializeAsync(StartUPContext context)
    {
        ...
        {
            var data = await File.ReadAllTextAsync(@"..\StartUP.Service\Seeding\CampaignDeal.json");
        ...
        {
            var data = await File.ReadAllTextAsync(@"..\StartUP.Service\Seeding\Users.json");
        ...
        {
            var data = await File.ReadAllTextAsync(@"..\StartUP.Service\Seeding\Project.json");
        ...
        {
            var data = await File.ReadAllTextAsync(@"..\StartUP.Service\Seeding\FeedBack.json");
        ...
        {
            var data = await File.ReadAllTextAsync(@"..\StartUP.Service\Seeding\SuccessStory.json");
        ...
        {
            var data = await File.ReadAllTextAsync(@"..\StartUP.Service\Seeding\FundingDetails.json");
